...
public class SymmetricCBCCircuitGenerator extends CircuitGenerator {
    ...
    public void generateSampleInput(CircuitEvaluator evaluator) {
        ...
        //concert hex representations of key and iv to binary reqpresentation
    ...
    public static void main(String[] args) {
        ...
        SymmetricCBCCircuitGenerator circuitGen = new SymmetricCBCCircuitGenerator("CBC", plainTextInHex, plainTextSizeIn64BitWords, key, iv);
